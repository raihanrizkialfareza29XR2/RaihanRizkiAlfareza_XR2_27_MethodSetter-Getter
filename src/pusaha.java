...
public class pusaha extends pkonsumsi{ // Class anak pusaha dari induk pkonsumsi
    ...
    public void Biodata(){ // Method void public untuk input data user
        ...
        System.out.println("");
        System.out.print("|Usaha Apa yang Sedang Anda Jalankan? : ");
        usaha = input.nextLine(); // Input Usaha User
        System.out.println("");
    ...
    public void setUsaha(String usaha){ // Method public void untuk memberikan set nilai berupa usaha user
        this.usaha = usaha;
    }
    public String getUsaha(){ // Method public non void untuk menampilkan usaha user
        System.out.println("");
        System.out.println("|Usaha Anda Saat Ini : " + usaha);
        return usaha;
    }
    ...
    public int getDurasi(){ // Method public non void untuk menampilkan durasi cicilan user
        System.out.println("");
        System.out.println("|Anda Akan Dikenakan Bunga Sebesar 2,2% / Tahun");
        bunga = (pinjaman*2.2/100); // Rumus menghitung bunga
        cicilan = (pinjaman+bunga); // Rumus menghitung cicilan
        cicilann = (cicilan/durasi);
        System.out.println("");
        System.out.println("|Rincian Pinjaman : Bunga = jumlah pinjaman x 2.2%"); // Menampilkan output rincian perhitungan pinjaman user
        System.out.println("|                   Bunga pinjaman = " + pinjaman + " x 2.2% = " + bunga);
        System.out.println("|                   Cicilan = (jumlah pinjaman + bunga) : durasi pinjaman");
        System.out.println("|                   Cicilan = (" + pinjaman + " + " + bunga + ") : " + durasi + " = " + cicilann + " Rupiah");
        System.out.println("");
    ...
    public void getRasio(){ // Method public void untuk menampilkan rasio cicilan terhadap penghasilan user
        double rasio = (cicilann*100)/penghasilan; // Rumus rasio cicilan terhadap penghasilan user
        System.out.println("");
        System.out.println("|                   Rasio Pendapatan Anda Terhadap Pinjaman : " + rasio + "%");
    }
